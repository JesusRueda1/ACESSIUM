<div class="modal fade" id="EditarUsuario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('ActualizarPerfil', Auth::user()->tbl_perfils->id) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_tbl_tipo_identificacions_id"
                                ...
                                <option value="{{ Auth::user()->tbl_perfils->tbl_tipo_identificacions->id }}">
                                    {{ Auth::user()->tbl_perfils->tbl_tipo_identificacions->tbl_tipo_identificacions_nombre }}</option>
                                {{-- @foreach ($tipoI as $ti)
                        ...
                        <div class="col-md-6" style="display: none;">
                            ...
                            <input type="number" class="form-control" id="tbl_perfil_idenficacion"
                                ...
                                value="{{ Auth::user()->tbl_perfils->tbl_perfil_idenficacion }}">
                        ...
                        <div class="col-md-12" style="display: none;">
                            ...
                            <input type="text" class="form-control" id="tbl_perfil_nombres" name="tbl_perfil_nombres"
                                ...
                                value="{{ Auth::user()->tbl_perfils->tbl_perfil_nombres }}">
                            <div class="invalid-feedback">Completa los datos</div>
                        </div>
                        <div class="col-md-12" style="display: none;">
                            ...
                            <input type="text" class="form-control" id="tbl_perfil_apellidos"
                                ...
                                value="{{ Auth::user()->tbl_perfils->tbl_perfil_apellidos }}">
                        </div>
                        <div class="col-md-6">
                            <label for="tbl_perfil_celular" class="form-label">Celular</label>
                            <input type="number" class="form-control" id="tbl_perfil_celular"
                                name="tbl_perfil_celular" pattern="[0-9]+" value="{{ Auth::user()->tbl_perfils->tbl_perfil_celular }}">
                            <div class="invalid-feedback">Completa los datos</div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="tbl_perfil_ciudad_Residencia"
                                name="tbl_perfil_ciudad_Residencia" onkeypress="return SoloLetras(event);" value="{{ Auth::user()->tbl_perfils->tbl_perfil_ciudad_residencia}}">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="tbl_perfil_direccion"
                                name="tbl_perfil_direccion" value="{{ Auth::user()->tbl_perfils->tbl_perfil_direccion }}">
                        ...
                        <div class="col-6">
                            ...
                            <select name="tbl_perfil_vacuna" id="tbl_perfil_vacuna"
                                ...
                                <option value="{{Auth::user()->tbl_perfils->tbl_perfil_vacuna}}">{{Auth::user()->tbl_perfils->tbl_perfil_vacuna}}</option>
                        ...
                        <div class="col-6">
                            ...
                            <select name="tbl_perfil_RH" id="tbl_perfil_RH"
                                class="form-select" aria-label="Default select example">
                                <option value="{{ Auth::user()->tbl_perfils->tbl_perfil_RH }}">{{ Auth::user()->tbl_perfils->tbl_perfil_RH }}</option>
                        ...
                        <div class="col-6">
                            ...
                            <select name="tbl_perfil_Estado_civil" id="tbl_perfil_Estado_civil" class="form-select"
                                ...
                                <option value="{{ Auth::user()->tbl_perfils->tbl_perfil_estado_civil }}">
                                    {{ Auth::user()->tbl_perfils->tbl_perfil_estado_civil }}</option>
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_estado" id="tbl_perfil_estado" class="form-select"
                                aria-label="Default select example">
                                <option value="{{ Auth::user()->tbl_perfils->tbl_perfil_estado }}">{{ Auth::user()->tbl_perfils->tbl_perfil_estado }}
                                </option>
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_sexo" id="tbl_perfil_sexo" class="form-select"
                                aria-label="Default select example">
                                <option value="{{ Auth::user()->tbl_perfils->tbl_perfil_sexo }}">{{ Auth::user()->tbl_perfils->tbl_perfil_sexo}}</option>
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_tbl_fichas_id" id="tbl_perfil_tbl_fichas_id" class="form-select"
                                aria-label="Default select example">
                                @if (Auth::user()->tbl_perfils->tbl_perfil_tbl_fichas_id != null)
                                    <option value="{{ Auth::user()->tbl_perfils->tbl_fichas->id }}">
                                        {{ Auth::user()->tbl_perfils->tbl_fichas->tbl_fichas_codigo }} -
                                        {{ Auth::user()->tbl_perfils->tbl_fichas->tbl_fichas_grupo }}</option>
                                @endif{{--
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_tbl_tipo_personals_id" id="tbl_perfil_tbl_tipo_personals_id"
                                ...
                                @if (Auth::user()->tbl_perfils->tbl_perfil_tbl_tipo_personals_id != null)
                                    <option value="{{ Auth::user()->tbl_perfils->tbl_tipo_personals->id }}">
                                        {{ Auth::user()->tbl_perfils->tbl_tipo_personals->tbl_tipo_personals_nombre }}</option>
                                @endif
                        ...
                        <div class="col-6" style="display: none;">
                            ...
                            <select name="tbl_perfil_tbl_centros_id" id="tbl_perfil_tbl_centros_id"
                                class="form-select" aria-label="Default select example" required>
                                @if (Auth::user()->tbl_perfils->tbl_perfil_tbl_centros_id != null)
                                    <option value="{{ Auth::user()->tbl_perfils->tbl_centros->id }}">
                                        {{ Auth::user()->tbl_perfils->tbl_centros->tbl_centros_nombre }}
                                    </option>
                                @endif
