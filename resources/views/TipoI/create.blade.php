    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                {{-- formulario --}}
                <form action="{{ route('GuardarTipoI') }}" method="POST" name="form-data" class="row needs-validation"
                    novalidate>
                    @csrf
                    <div class="col-md-6">
                        <label for="tbl_tipo_identificacions_nombre" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="tbl_tipo_identificacions_nombre"
                            name="tbl_tipo_identificacions_nombre" required onkeypress="return SoloLetras(event);">
